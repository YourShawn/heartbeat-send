...
CREATE TABLE heartbeat_recording (
    ...
    bpm_nominal SMALLINT NOT NULL COMMENT 'Representative BPM used as the local playback baseline (40-220)',
    ...
    duration_seconds SMALLINT NOT NULL COMMENT 'Intended playback length in whole seconds',
